  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const synthStep = new CodeBuildStep('Synth', {
      ...
      commands: [
        ...
        'if [ ! -d ".git" ]; then && git init && git remote add origin "$remote_origin && git fetch && git checkout -f "$CODEBUILD_RESOLVED_SOURCE_VERSION" && fi',
        'git submodule init',
